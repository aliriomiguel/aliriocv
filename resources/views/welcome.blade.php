                    ...
                    <div class="modal-content">
                        ...
                        <div class="container">
                            ...
                            <div class="col-lg-8">
                                ...
                                <img class="img-fluid rounded mb-5 img-project" src="storage/img/portfolio_pictures/{{$pentry->picture}}" alt="portfolioPicture">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="portfolio-item mx-auto">
                    ...
                    <img class="img-fluid center-image img-skills" src="/storage/img/icons/{{$service->icon}}" style="width:50%;">
