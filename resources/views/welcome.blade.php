            ...
            @foreach($portfolio as $pentry)
                <div class="col-md-6 col-lg-4">
                    <div class="portfolio-item mx-auto" data-toggle="modal" data-target="#portfolioModal{{$pentry->id}}">
                        ...
                        </div><!--storage/img/portfolio_pictures/{{$pentry->picture}}-->
                        <img class="img-fluid center-image" src="https://universoalterno.com/aliriocv/storage/img/portfolio_pictures/{{$pentry->picture}}" style="width:100%;" alt="portfolioPicture">
                    </div>
                </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="container">
                            ...
                            <div class="col-lg-8">
                                ...
                                <img class="img-fluid rounded mb-5" src="https://universoalterno.com/aliriocv/storage/img/portfolio_pictures/{{$pentry->picture}}" alt="portfolioPicture">
                                ...
                                @if($pentry->picture2)
                                <img class="img-fluid rounded mb-5" src="https://universoalterno.com/aliriocv/storage/img/portfolio_pictures/{{$pentry->picture2}}">
                                @endif
                                @if($pentry->picture3)
                                <img class="img-fluid rounded mb-5" src="https://universoalterno.com/aliriocv/storage/img/portfolio_pictures/{{$pentry->picture3}}">
                                @endif
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="portfolio-item mx-auto">
                    ...
                    <img class="img-fluid center-image" src="https://universoalterno.com/aliriocv/storage/img/icons/{{$service->icon}}" style="width:50%;">
        ...
        <div class="row">
            ...
            @foreach($posts as $post)
                ...
                <div class="card bg-dark text-white" style="width:100%; margin-bottom:16px;">
                    <img src="https://universoalterno.com/aliriocv/storage/img/posts_pictures/{{$post->picture}}" class="card-img" alt="BlogImage{{$post->id}}">
        ...
        <div class="row">
            ...
            <div class="card-group">
                @foreach($posts as $post)
                    @if($post->featured == 0)
                        <div class="card">
                            <img class="card-img-top" src="https://universoalterno.com/aliriocv/storage/img/posts_pictures/{{$post->picture}}" alt="Card image cap">
                            <div class="card-body">
